      ...
      <div className="about__data grid">
        <div className="about__info">
          <p className="about__description">
            I am Matthew Smith, Web Developer based out of Austin, Texas, United
            States. I have rich experience in building contemporary user
            interfaces with accessability and performance optimization in mind.
          </p>
